...
/*
    Oggetto env.json definito come:
    "PRIVATE_KEY": 
    "ALCHEMY_API_KEY":
    "ETHERSCAN_API_KEY"
    "SEPOLIA_RPC_URL": 
    "CERTIFICATE_NFT_ADDRESS":
    "CERTIFICATE_NFT_GOVERNANCE"
...
async function loadEnv() {
    ...
    // let address = env.CERTIFICATE_NFT_ADDRESS
    // let rpc_URL = env.SEPOLIA_RPC_URL
    // return [address, rpc_URL]
    return env
}

env = await loadEnv()
export let contractAddress = env["CERTIFICATE_NFT_ADDRESS"]
export let governanceContractAddress = env["CERTIFICATE_NFT_GOVERNANCE"]
export let SEPOLIA_RPC_URL = env["SEPOLIA_RPC_URL"]
export let projectFactoryAddress = env["PROJECT_FACTORY_ADDRESS"]
export let userNFTAddress = env["USER_NFT_ADDRESS"];
export const WALLET_PRIVATE_KEY = env["PRIVATE_KEY"]
export const ipfs = window.IpfsHttpClient.create({ url: 'http://127.0.0.1:5001' });
...
export const abi = [
    ...
    },
    {
        ...
        "name": "verifiedInstitutionAlreadyExist",
        "type": "error"
    },
    {
        "anonymous": false,
...
export const userNFTAbi = [
    ...
    },
    {
        ...
        "outputs": [
            {
                "internalType": "contract ProjectFactory",
                "name": "",
                "type": "address"
            }
        ],
...
export const factoryAbi = [
    ...
    },
    {
        "inputs": [
            {
                "internalType": "address",
                "name": "addressToBeVerified",
                "type": "address"
            }
        ],
        "name": "isProjectAddress",
        "outputs": [
            {
                "internalType": "bool",
                "name": "",
